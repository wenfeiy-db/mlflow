...
@click.option('--explain-path', help='Output path of explanation')
def explain_step(pipeline_path, tracking_uri, run_id, train_path, explain_path):
    ...
    plt.savefig(explain_path, format='svg')
    ...
    with open(run_id, 'r') as f:
        ...
        with mlflow.start_run(run_id=run_id):
            mlflow.log_artifact(explain_path)
