...
class TransformStep(BaseStep):
    ...
    def __init__(self, step_config, pipeline_root):
        ...
        self.transform_module_name, self.transform_method_name =\
    ...
    def _run(self, output_directory):
        ...
        transformer_fn = getattr(importlib.import_module(self.transform_module_name), self.transform_method_name)
